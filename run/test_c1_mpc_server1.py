...
def main():
    ...
    while True:
        ...
        with time_block("total_time"):
            ...
            with time_block("online_time"):
                y1 = secure_c1_fixed_inference(
                    ...
                    conv5_w_i=conv5_w1,
                    conv5_b_i=conv5_b1,
                    bn5_eps1_i=bn5_eps11,
                    bn5_eps2_i=bn5_eps21,

                    conv6_w_i=conv6_w1,
                    conv6_b_i=conv6_b1,
                    bn6_eps1_i=bn6_eps11,
                    bn6_eps2_i=bn6_eps21,

                    conv7_w_i=conv7_w1,
                    conv7_b_i=conv7_b1,
                    bn7_eps1_i=bn7_eps11,
                    bn7_eps2_i=bn7_eps21,

                    fc1_w_i=fc1_w1,
                    fc1_b_i=fc1_b1,
                    bn8_eps1_i=bn8_eps11,
                    bn8_eps2_i=bn8_eps21,
        ...
        print_report("Party1 Sonic C1 MPC Profiler")
