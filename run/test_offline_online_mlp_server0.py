...
def main():
    ...
    # 根据当前网络规模预留 offline triples。
    # 当前测试需要：
    # arithmetic triples: (1,2) 和 (1,1)
    # bit triples       : (1,2) 和 (1,1)
    arith_plan = [
        ((1, 2), 80),
        ((1, 1), 80),
    ]
    ...
    print("===== Offline / Online Fixed-point MLP Test =====")
    ...
    print_report("Party0 Offline / Online Profiler")
